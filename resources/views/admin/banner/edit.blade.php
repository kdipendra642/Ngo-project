                ...
                <div class=" form">
                    <form class="form-horizontal" method="POST" action="{{route($_base_route.'.update',$banner->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10">
                                <input class=" form-control" type="file" id="image" name="image" accept="image/png, image/gif, image/jpeg" onchange="previewImage(this)" value="{{ $banner->image }}">
                                <img id="previewImg" src="{{ asset('image/banner/'.$banner->image) }}" alt="" style="max-width: 130px; margin-top: 20px;">
                                @if ($errors->has('image'))
