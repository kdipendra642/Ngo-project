...
<!-- sidebar menu start-->
    <ul class="sidebar-menu" id="nav-accordion">
        ...
        <li class="sub-menu  ">
            <a href="javascript:;" class="{{ ( (request()->is('admin/category*')) || (request()->is('admin/posts*')) ) ? 'active open ' : '' }}">
        ...
        <li class="sub-menu  ">
            <a href="javascript:;" class="{{ ( (request()->is('admin/banner*')) || (request()->is('admin/donors*')) ) ? 'active open ' : '' }}">
                <i class="fa fa-shopping-cart"></i>
                <span>Accessories</span>
            </a>
            <ul class="sub">
                <li class="{{ 'admin/banner' == request()->path() ? 'active' : '' }}"><a  href="{{ route('admin.banner') }}" > <i class="fa fa-arrows-h"></i>  Sliders</a></li>
                <li class="{{ 'admin/donors' == request()->path() ? 'active' : '' }}"><a  href="{{ route('admin.donors') }}" > <i class="fa fa-arrows-h"></i>  Donors</a></li>
            </ul>
